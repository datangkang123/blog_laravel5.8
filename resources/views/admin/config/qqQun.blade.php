    ...
    <form class="form-inline" enctype="multipart/form-data" action="{{ url('admin/config/update') }}" method="post">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <th>QQ群代码：</th>
                <td>
                    <textarea class="form-control modal-sm" name="152" rows="5" placeholder="">{{  $config['bjyblog.qq_qun.code'] }}</textarea><a href="https://jq.qq.com/?_wv=1027&k=58QVaZb" target="_blank"></a>
                </td>
            </tr>
            <tr>
                <th>QQ群二维码：</th>
                <td>
                    ...
                    <a href="http://qun.qq.com/join.html" target="_blank"></a>
                </td>
            </tr>
            <tr>
                <th></th>
